...
export default function ImpressumPage() {
  const vorstandsmitglieder = [
    ...
    { rolle: 'Kassenwart', name: 'Tobias Mittag', icon: <IconScale size={20} /> },
    { rolle: 'Spielausschussvorsitzender', name: 'Kevin Niedens', icon: <IconUsers size={20} /> },
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 dark:bg-viktoria-dark rounded-lg p-4">
                      ...
                      <div className="text-sm text-gray-700 dark:text-gray-300 space-y-1 pl-6">
                        ...
                        <p className="font-medium">Registernummer: VR 306</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    Alle Angaben entsprechen dem Stand vom Januar 2024. Änderungen vorbehalten.
